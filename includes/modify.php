...
<!-- ***********************************************************************************
  ...
  Program #  : Program #2
  Purpose    : If this page is called from the controller it will display data given by the user and let the user know they pressed the modify button. 
  Due Date   : 02/21/2023 
...
<html>                       <!-- start of html (Hyper Text Markup Language) --> 
  ...
  <body>                     <!-- start of the body section -->
    ...
    <center><font color="#CC33FF" face="Impact" size="5">You pressed the Modify Button</font></center>
